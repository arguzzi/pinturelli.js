...
/* (A) */ customRootId: "_myFirstRoot", // Default: `_root_${rootCount}` | Must starts with "_"
/* (B) */ containerId: "sketch_container_0", // Default: null (auto: main elt, or body elt)
...
/* (H) */ // q5MaxFrameRate: 30, // Default: 60
/* (I) */ nodesTracker: "*", // Default: []
/*     */ // ^ ^ alt: string <--selectAll (with root preconfigured as the origin)
/*     */ // ^ ^ alt: array of strings <--list of ids [nodeId, nodeId, ...]
/* (J) */ eventsTracker: ["$tapped"], // Default: [] | Semantic names array
/* (K) */ memoryTracker: ["ALL_NODES"], // Default: ["ALL_NODES"]
/*     */ // ^ ^ alt: ["CONFIG", "GLOBAL", "ALL_NODES", "ASSETS", "EVENT_BUS"]
/* (L) */ treeAssets: { // Default: {}
